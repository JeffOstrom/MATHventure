...
import multiplicationprobs2 from "../multiplicationproblems2.json"
import Timer from "../components/Timer/timer.js";


class MultiplicationMedium extends Component {
    state = {
        multiplicationprobs2,
        answer: "?",
        modal: "",
        question: "",
        firstChoice: 0,
    ...
    componentDidMount() {
        ...
        const random = this.state.multiplicationprobs2[Math.floor(Math.random() * this.state.multiplicationprobs2.length)];
