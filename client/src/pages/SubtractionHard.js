...
import subtractionprobs3 from "../subtractionproblem3.json"
import Timer from "../components/Timer/timer.js";


class SubtractionHard extends Component {
    state = {
        subtractionprobs3,
        answer: "?",
        modal: "",
    ...
    componentDidMount() {
        ...
        const random = this.state.subtractionprobs3[Math.floor(Math.random() * this.state.subtractionprobs3.length)];
...
export default SubtractionHard;