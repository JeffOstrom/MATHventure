...
import multiplicationprobs3 from "../multiplicationproblems3.json"
import Timer from "../components/Timer/timer.js";


class MultiplicationHard extends Component {
    state = {
        multiplicationprobs3,
        answer: "?",
        modal: "",
        question: "",
        firstChoice: 0,
    ...
    componentDidMount() {
        ...
        const random = this.state.multiplicationprobs3[Math.floor(Math.random() * this.state.multiplicationprobs3.length)];
...
export default MultiplicationHard;