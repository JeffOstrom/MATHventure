...
import subtractionprobs2 from "../subtractionproblems2.json"
import Timer from "../components/Timer/timer.js";


class SubtractionMedium extends Component {
    state = {
        subtractionprobs2,
        answer: "?",
        modal: "",
    ...
    componentDidMount() {
        ...
        const random = this.state.subtractionprobs2[Math.floor(Math.random() * this.state.subtractionprobs2.length)];
...
export default SubtractionMedium;