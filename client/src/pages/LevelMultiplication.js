...
class LevelMultiplication extends Component {
                ...
                <div className="row">
                    <div className="col login-sec" align= "center">
                        <h2 id="textMathLevel" className="text-center">Select a difficulty level.</h2>
                            <div className="col-8">
                                    <Link type="button1" id="buttonLevel" className="btn btn btn-lg btn-block" to="/Multiplication">
                                        Easy
                                    </Link>
                         </div>
                         <div className="col-8">
                                    <Link type="button2" id="buttonLevel" className="btn btn btn-lg btn-block" to="/MultiplicationMedium">
                                        Medium
                                    </Link>
                         </div>
                         <div className="col-8">
                                    <Link type="button3" id="buttonLevel" className="btn btn btn-lg btn-block" to="/MultiplicationHard">
                                        Hard
                                    </Link>
                         </div>
                    </div>
...
export default LevelMultiplication;
